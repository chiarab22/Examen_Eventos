package com.example.android.mistareasv1_v2;
...
public class AddModifyTask extends AppCompatActivity {
    ...
    public void init_modify() {
        toolbar_title.setText("Modificar Tarea");
        save_btn.setText("Actualizar");
    ...
    public void saveTask(View v) {
        ...
        if (edit_text.getText().toString().trim().length() > 0) {
            ...
            if (isModify) {
                ...
                Toast.makeText(getApplicationContext(), "Tarea añadida.", Toast.LENGTH_SHORT).show();
            }
            finish();

        } else {
            Toast.makeText(getApplicationContext(), "No se puede guardar una tarea vacía.", Toast.LENGTH_SHORT).show();
        }
    ...
    public void deleteTask(View v) {
        ...
        Toast.makeText(getApplicationContext(), "Tarea borrada", Toast.LENGTH_SHORT).show();
        finish();
    }
    ...
    public void chooseDate(View view) {
        ...
        builder.setTitle("Seleccionar una fecha");
        builder.setNegativeButton("Borrar", null);
        builder.setPositiveButton("Poner", new DialogInterface.OnClickListener() {
